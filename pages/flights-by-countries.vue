            ...
            <div class="ml-2">
                ...
                <div class="External Links">
                    <ul class="flex flex-col lg:flex-row lg:space-x-6 space-y-6 lg:space-y-0 mt-4 font-medium">
                        <li class="">
                            <nuxt-link to="/flights-by-cities" class="hover:text-sky-500"> Find Cheap Flights to all Cities
                        ...
                        <li class="">
                            <nuxt-link to="/flights-by-states" class="hover:text-sky-500"> Find Cheap Flights to all States
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="none"
                                    stroke="currentColor" stroke-width="0.8"
                                    class="ml-2 inline-block bi bi-box-arrow-up-right" viewBox="0 0 16 16">
                                    <path fill-rule="evenodd"
